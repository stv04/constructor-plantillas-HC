...
namespace back.models
{
    ...
    {
        [Key]
        public object AUTO_INC_RPC { get; set; }
        ...
        public object TX_NOMBRPT_RPC { get; set; }
        public object TX_FORMRPT_RPC { get; set; }
        public int NU_EDITA_RPC { get; set; }
        public object TX_CAMPOSASOCIA_RPC { get; set; }
        public object TX_KEYESTILO_RPC { get; set; }
        public object NU_INVACTASO_RPC { get; set; }
        public string TX_ALINEAROTULO_RPC { get; set; }
        public int NU_ORDEN_COLDEP_RPC { get; set; }
        public object ES_SEMA_RPC { get; set; }
        public object TX_DESC_SEMA_RPC { get; set; }
        public object TX_VALOR_SEMA_RPC { get; set; }
        public object TX_RELA_SEMA_RPC { get; set; }
        public object TX_COLOR_SEMA_RPC { get; set; }
    }
}